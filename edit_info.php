...
<?php include('navbar_dasboard.php'); ?>
    <div class="container">
		...
		<div class="alert alert-info">Time Guide for Each Number</div>
				...
				<div class="alert alert-info">Office Hours</div>
						...
						<p>Friday - Saturday (8:00 am to 12:00 pm)</p>
						<p>Sunday ( Closed ) </p>
						<p>Room B401</p>
						<p>D'Clean President University</p>
						<p>Jabebeka City, North Cikarang</p>
	...
	?>
				...
				<div class="alert alert-info">D'Clean </div>	
					<img  class="img img-polaroid" src="images/c.png">
				</div>
